package flutter.moum.airplane_mode_detection.airplane_mode_detection;
...
public class AirplaneModeDetectionPlugin extends FlutterApplication implements MethodCallHandler {
  /** Plugin registration. */
